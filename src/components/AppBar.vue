<template>
      ...
      <var-app-bar round title-position="center" class="app-bar">
        ...
        <template #right>
          <var-menu placement="bottom" same-width :offset-y="6">
            ...
            <template #menu>
              <var-button text block @click="() => StyleProvider(null)">混沌邪恶</var-button>
              <var-button text block @click="() => StyleProvider(Themes.dark)">混沌善良</var-button>
              <var-button text block @click="() => StyleProvider(Themes.md3Light)"
                >守序邪恶</var-button
              >
              <var-button text block @click="() => StyleProvider(Themes.md3Dark)"
                >守序善良</var-button
              >
            </template>
          </var-menu>
  ...
  <div class="footer">
    ...
    <div class="divider-vertical-container">
      ...
      <var-link underline="none" text-color="#39c5bb" href="https://krau.top" target="_blank"
        >博客</var-link
      >
    </div>
  </div>
